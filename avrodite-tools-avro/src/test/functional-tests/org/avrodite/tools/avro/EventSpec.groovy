...
class EventSpec extends Specification {
  ...
  def setup() {
    ...
    EVENT_SCHEMA = AVRO_CODEC_MANAGER.<EquityMarketPriceEvent, AvroCodec<EquityMarketPriceEvent>>getBeanCodec(EquityMarketPriceEvent.class).getSchema()
    META_SCHEMA = AVRO_CODEC_MANAGER.<EventMeta, AvroCodec<EventMeta>> getBeanCodec(EventMeta.class).getSchema()
    EQUITY_SCHEMA = AVRO_CODEC_MANAGER.<Equity, AvroCodec<Equity>> getBeanCodec(Equity.class).getSchema()
    AVRODITE_CODEC = (AvroCodec<EquityMarketPriceEvent>) AVRO_CODEC_MANAGER.getBeanCodec(EquityMarketPriceEvent.class)
