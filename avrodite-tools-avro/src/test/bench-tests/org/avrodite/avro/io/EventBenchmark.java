...
public class EventBenchmark {
  ...
  static AvroCodec<EquityMarketPriceEvent> codec = CodecProvider.INSTANCE.avroCodec();
  ...
  static EquityMarketPriceEvent event = EquityMarketPriceEvent.Companion.createEvent(124.214);
